...
/* Placeholder repository base URL.  Will be updated when GitHub Pages      *
 * repository is live (Phase 4, task 4.8).                                  */
#define NOS_INDEX_REPO_URL      "http://nosdos.example.com/packages"
#define NOS_INDEX_URL           NOS_INDEX_REPO_URL "/packages.idx"
