...
def write_config_files(img_path: Path) -> bool:
    ...
    autoexec_bat = (
        ...
        "ECHO.\r\n"
        # Load PCnet packet driver before DETECT so nos_detect_network() finds
        # the Crynwr "PKT DRVR" signature at INT 60h.  Must come before DETECT.
        "LH A:\\NOS\\SYSTEM\\PCNTPK.COM INT=0x60 > NUL\r\n"
        # Load mouse driver before DETECT so JEMMEX/CTMOUSE interaction is tested.
        # /P forces PS/2 mode — skips serial port probing (all VMs are PS/2).
        "A:\\NOS\\SYSTEM\\CTMOUSE.EXE /P > NUL\r\n"
        ...
        "A:\\NOS\\SYSTEM\\DETECT.EXE /NOREBOOT /FORCE > COM1\r\n"
        "ECHO.\r\n"
